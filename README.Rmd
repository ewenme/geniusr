...
# search for Nas
search_song(search_term = "Nas")

# search track on illmatic
get_song_meta(song_id = 89)

# scrape album tracklist
illmatic_tracklist <- scrape_tracklist(album_id = 7013)

# scrape album lyrics
illmatic_lyrics <- map_df(illmatic_tracklist$song_lyrics_url, scrape_lyrics_url)
```
